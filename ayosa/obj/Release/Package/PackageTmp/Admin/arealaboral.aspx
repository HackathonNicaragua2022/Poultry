<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/master01a.Master" AutoEventWireup="true" CodeBehind="arealaboral.aspx.cs" Inherits="POULTRY.arealaboral" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Area Laboral</title>
        ...
        <ContentTemplate>
            <fieldset>
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <h1>Mantenimiento de areas Laborales</h1>
                        </div>
                        <div class="col-sm-4">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <asp:GridView ID="gv_area" DataKeyNames="ID_Area" OnDataBound="gv_area_DataBound" CssClass="table table-dark table-striped table-hover" runat="server" EnableViewState="False" AutoGenerateColumns="false" PageSize="50" AllowPaging="True" Style="max-width: 100%" OnRowCommand="gv_area_RowCommand">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Nombre Area">
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" Text='<%# Bind("NombreArea") %>' ID="TextBox1"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label runat="server" Text='<%# Bind("NombreArea") %>' ID="Label1"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                <PagerTemplate>
                                    <div class="row" style="margin-top: 20px;">
                                        ...
                                        <div class="col-lg-1" style="text-align: left;">
                                            <asp:DropDownList ID="dr_areaPage" Width="70px" AutoPostBack="true" OnSelectedIndexChanged="dr_areaPage_SelectedIndexChanged" runat="server" CssClass="form-control"></asp:DropDownList>
                                        </div>
                                        <div class="col-lg-10" style="text-align: right;">
                                            <h3>
                                                <asp:Label ID="currentPage_Area" runat="server" CssClass="label label-warning" />
                                            </h3>
                                        </div>
                                    </div>
                                </PagerTemplate>
                    ...
                    <div class="modal fade" id="formulario01" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Area Laboral</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="txt_Area">Nombre del Area</label>
                                                <asp:TextBox ID="txt_Area" runat="server" class="form-control" required MaxLength="50"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <asp:Button ID="btn_Guardar" runat="server" Text="Nueva Area" CssClass="btn btn-info form-control" OnClick="btn_Guardar_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
