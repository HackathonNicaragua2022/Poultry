<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/masterGranja.Master" AutoEventWireup="true" CodeBehind="TratamientosMedicos.aspx.cs" Inherits="POULTRY.GranjaSanFrancisco.TratamientosMedicos" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Tratamientos de Medicamentos</title>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="jumbotron jumbotron-image shadow m-1 border-primary" style="background-image: url(../imagenes/pollitos-galera.jpeg);">
        <div class="row">
            <div class="col-10">
                <h2 class="mb-4 text-white"><b>REGISTRO TRATAMIENTOS MEDICOS LOTE EN CRECIMIENTO</b></h2>
                <p class="mb-4 text-white">
                    Registre Todo el tratamiento medico aplicado al Lote en Crecimiento
                </p>
            </div>
            <div class="col-md-2 col-sm-12 float-right">
                <img src="../imagenes/cruzmedicaml.png" width="128" alt="corazon medico" />
            </div>
        </div>
    </div>
    ...
    <asp:UpdatePanel ID="up_principal" runat="server">
        <ContentTemplate>
            ...
            <div class="callout callout-warning">
                <h3 class="text-primary">DATOS DEL TRATAMIENTO</h3>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            <label for="txt_inicioTratamiento">Inicio Tratamiento</label>
                            <div class="input-group">
                                ...
                                <asp:TextBox runat="server" ID="txt_inicioTratamiento" name="txt_inicioTratamiento" TextMode="DateTimeLocal" class="form-control" aria-describedby="txt_inicioTratamiento_HelpBlock" />
                            </div>
                            <span id="txt_inicioTratamiento_HelpBlock" class="form-text text-muted">Fecha de Inicio del tratamiento medico</span>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            <label for="txt_finTratamiento">Fin Tratamiento</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <i class="fas fa-calendar"></i>
                                ...
                                <asp:TextBox runat="server" ID="txt_finTratamiento" name="txt_inicioTratamiento" TextMode="DateTimeLocal" class="form-control" aria-describedby="txt_finTratamiento_HelpBlock" />
                            </div>
                            <span id="txt_finTratamiento_HelpBlock" class="form-text text-muted">Fecha de Finalizacion del tratamiento medico</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <asp:TextBox runat="server" ID="txt_ConceptoAplicacion" name="txt_Cantidad" TextMode="MultiLine" MaxLength="520" placeholder="" type="text" class="form-control" aria-describedby="txt_ConceptoAplicacion_ialHelpBlock" />
                            </div>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group">
                            <label for="txt_CantidadDosis">Cantidad Total Dosis</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                ...
                                <asp:TextBox runat="server" ID="txt_CantidadDosis" TextMode="Number" name="txt_CostoPorFrasco" placeholder="0" type="text" class="form-control" aria-describedby="txt_CantidadDosis_HelpBlock" />
                            </div>
                            <span id="txt_CantidadDosis_HelpBlock" class="form-text text-muted">Cantidad de Dosis Aplicada</span>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group">
                            <label for="txt_CostoPorDosis">Costo x Dosis</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <div class="input-group-text">
                                        <i class="fa fa-money-bill"></i>
                                ...
                                <asp:TextBox runat="server" ID="txt_CostoPorDosis" TextMode="Number" name="txt_CostoPorDosis" placeholder="0" type="text" class="form-control" aria-describedby="txt_CostoPorDosis_HelpBlock_HelpBlock" />
                            </div>
                            <span id="txt_CostoPorDosis_HelpBlock" class="form-text text-muted">Costo por dosis aplicada (se guardar en sistema)</span>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <span id="txt_CostoTotal_HelpBlock" class="form-text text-muted">Costo Total de la aplicacion</span>
                        </div>
                    </div>

                </div>
                <div class="form-group">
                    <asp:Button Text="GUARDAR TRATAMIENTO" OnClick="btn_GuardarMedicamento_Click" class="btn btn-primary btn-lg elevation-2 border-dark" ID="btn_GuardarMedicamento" CausesValidation="false" UseSubmitBehavior="false" runat="server" />
                </div>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="debajoScripts" runat="server">
    ...
    <script>
        document.getElementById("<%=txt_CantidadDosis.ClientID%>").onkeyup = costoXTotal;
        document.getElementById("<%=txt_CostoPorDosis.ClientID%>").onkeyup = costoXTotal;
        function costoXTotal() {
            try {
                var cantidad = document.getElementById('<%=txt_CantidadDosis.ClientID%>').value;
                var Costo = document.getElementById('<%=txt_CostoPorDosis.ClientID%>').value;
                var costoTotal = (parseFloat(cantidad) * parseFloat(Costo));
