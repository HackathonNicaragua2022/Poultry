<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/mobilnav.Master" AutoEventWireup="true" CodeBehind="FacturasContadoComedor.aspx.cs" Inherits="POULTRY.mobilnavs.FacturasContadoComedor" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Facturas de Contado</title>
    <!-- daterange picker -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Facturas de Contado</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="menuComedorTrabajadores.aspx">Menu</a></li>
                        <li class="breadcrumb-item active">Facturas de Contado</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <ContentTemplate>
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        ...
                        <div class="form-group">
                            <asp:Button ID="btn_cargar" Text="Cargar Facturas" runat="server" class="btn btn-success form-control" aria-describedby="btncargar" OnClick="btn_cargar_Click" />
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-12">
                        <button type="button" class="btn btn-primary" onclick="printContent('FacturasCredito');">
                            <i class="fas fa-print"></i>&nbsp Imprimir Facturas de Contado
                        </button>
                    </div>
                </div>
                <br />
                ...
                <div class="invoice p-3 mb-3 bg-gradient-dark" id="FacturasCredito">
                    ...
                    <div class="row">
                        <div class="col-12 table-responsive">
                            <asp:GridView ID="gv_Facturas_contado" runat="server" AutoGenerateColumns="false" DataKeyNames="ID_Factura" OnRowDataBound="gv_Facturas_contado_RowDataBound" RowStyle-Wrap="true"
                                CssClass="table table-sm table-condensed table-dark  table-bordered table-striped" EmptyDataText="No se encontraron Facturas de contado en el rango seleccionado">
                                <Columns>
    ...
    <script>
        jQuery(document).ready(function ($) {
            $(document).ready(function () {
                $("#<%=gv_Facturas_contado.ClientID%>").footable();
