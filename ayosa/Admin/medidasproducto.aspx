<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/master01a.Master" AutoEventWireup="true" CodeBehind="medidasproducto.aspx.cs" Inherits="POULTRY.medidasproducto" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Medidas de Producto</title>
        ...
        <ContentTemplate>
            <fieldset>
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
                            <h1>Mantenimiento de Medidas de Productos</h1>
                        </div>
                        <div class="col-sm-4">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#formulario01">
                                Agregar Medida <i class="fas fa-plus-circle"></i>
                            </button>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <asp:GridView ID="gv_Medida" DataKeyNames="ID_Medida" OnDataBound="gv_Medida_DataBound" CssClass="table table-dark table-striped table-hover" runat="server" EnableViewState="False" AutoGenerateColumns="false" PageSize="50" AllowPaging="True" Style="max-width: 100%" OnRowCommand="gv_Medida_RowCommand">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Medida Producto">
                                        <EditItemTemplate>
                                            <asp:TextBox runat="server" Text='<%# Bind("MedidaProducto") %>' ID="TextBox1"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label runat="server" Text='<%# Bind("MedidaProducto") %>' ID="Label1"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                ...
                                <PagerTemplate>
                                    <div class="row" style="margin-top: 20px;">
                                        ...
                                        <div class="col-lg-1" style="text-align: left;">
                                            <asp:DropDownList ID="dr_Medida_Page" Width="70px" AutoPostBack="true" OnSelectedIndexChanged="dr_Medida_Page_SelectedIndexChanged" runat="server" CssClass="form-control"></asp:DropDownList>
                                        </div>
                                        <div class="col-lg-10" style="text-align: right;">
                                            <h3>
                                                <asp:Label ID="currentPage_Medida" runat="server" CssClass="label label-warning" />
                                            </h3>
                                        </div>
                                    </div>
                                </PagerTemplate>
                    ...
                    <div class="modal fade" id="formulario01" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">Medida de Productos</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="txt_Medida">Nombre de la Medida</label>
                                                <asp:TextBox ID="txt_Medida" runat="server" class="form-control" required MaxLength="50"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <asp:Button ID="btn_Guardar" runat="server" Text="Nueva Medida" CssClass="btn btn-info form-control" OnClick="btn_Guardar_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            $(document).ready(function () {
                ...
                $('#ContentPlaceHolder1_gv_Medida').footable();
            });
