<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/master-admin.Master" AutoEventWireup="true" CodeBehind="home-admin.aspx.cs" Inherits="POULTRY.Admin_gerencial.home_admin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">INICIO- Dashboard</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                Granjas de Aves ponedoras
                </h3>
                            <div class="card-tools">
                                <div class="align-content-center">
                                    <img class="elevation-1 img-rounded" src="../imagenes/galeravacia.jpg" width="100%" style="display: block; margin-left: auto; margin-right: auto;" />
                                    <br />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                Consumo de Concentrado Aves Engorde vrs Aves Ponedoras
                </h3>
                            <div class="card-tools">
                    ...
                    <div class="card bg-gradient-info">
                        <div class="card-header border-0">
                            <h3 class="card-title">
                               ...
                               Pesos Promedios Javas Enviadas
                </h3>
