...
{
    public partial class FacturasCreditosComedor : System.Web.UI.Page
    {
        ...
        public void fillFacturas()
        {
            try
            {
                ...
                List<Tbl_FaturaComedor_obj.facturasComedor> result = facturasxTrabajador.getFacturasComedorxidTrabajador((int)Session["IDTrabajador"], fecha1, fecha2);
                ...
                gv_Facturas_Pendientes.DataSource = listafacturas;
                gv_Facturas_Pendientes.DataBind();
                if (gv_Facturas_Pendientes.Rows.Count > 0)
                {
                    this.gv_Facturas_Pendientes.UseAccessibleHeader = true;
                    TableCellCollection cells = gv_Facturas_Pendientes.HeaderRow.Cells;


                    gv_Facturas_Pendientes.HeaderRow.Cells[0].Attributes["data-class"] = "expand";
                    ...
                    gv_Facturas_Pendientes.HeaderRow.TableSection = TableRowSection.TableHeader;
                }
        ...
        protected void gv_Facturas_Pendientes_PreRender(object sender, EventArgs e)
        {
        ...
        protected void gv_Facturas_Pendientes_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {

                int ID_Factura = (int)gv_Facturas_Pendientes.DataKeys[e.Row.RowIndex].Value;
                //----------------------------------------------------------------------------------
                ...
                //if (gv_DetalleFacturas.Rows.Count > 0)
                //{
                //    gv_DetalleFacturas.UseAccessibleHeader = true;
                //    TableCellCollection cells = gv_DetalleFacturas.HeaderRow.Cells;


                //    gv_DetalleFacturas.HeaderRow.Cells[0].Attributes["data-class"] = "expand";
                //    cells[3].Attributes.Add("data-breakpoints", "all");
                //    //cells[2].Attributes.Add("data-breakpoints", "all");
                //    //cells[6].Attributes.Add("data-breakpoints", "xs sm md");
                //    //cells[4].Attributes.Add("data-breakpoints", "xs sm md");           
                //    gv_DetalleFacturas.HeaderRow.TableSection = TableRowSection.TableHeader;
                //}            
            }
        }
    }
