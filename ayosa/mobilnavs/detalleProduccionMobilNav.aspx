<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/mobilnav.Master" AutoEventWireup="true" CodeBehind="detalleProduccionMobilNav.aspx.cs" Inherits="POULTRY.mobilnavs.detalleProduccionMobilNav" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col">
            <asp:LinkButton Text="text" runat="server" PostBackUrl="~/mobilnavs/inventariomob.aspx">
...
<asp:Content ID="bajoScripContent" ContentPlaceHolderID="debajoScripts" runat="server">
</asp:Content>
